...
<select name="id_chofer"
        required
        onchange="checkNuevo(this,'../choferes/nuevo.php')">
...
<select name="id_vehiculo"
        required
        onchange="checkNuevo(this,'../vehiculos/nuevo.php')">
...
required
onchange="checkNuevo(this,'../ubicaciones/nuevo.php')">
...
<textarea name="objeto_movilizacion"
rows="3"
required></textarea>
</div>
...
required
onchange="checkNuevo(this,'../directores/nuevo.php')">
...
const dias=
document.getElementById("dias_movilizacion").value;
