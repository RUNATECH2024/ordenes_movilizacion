...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Ejecución pasando los marcadores de posición parametrizados de forma segura
        $stmt->execute([
    ...
    // Si intentan acceder directamente por GET, los enviamos de vuelta al formulario
